...
# null
nullBoutLength <- lm(data = anthBinDataBoutLength, formula = avg_bout_length_s ~ 1, weights = n_obs)
...
# linear
linearBoutLength <- lm(data = anthBinDataBoutLength, formula = avg_bout_length_s ~ avg_anth_dist, weights = n_obs)
...
# null
nullHowlsMin <- lm(data = anthBinDataHowlsMin, formula = avg_howl_per_min ~ 1, weights = n_obs)
...
# linear
linearHowlsMin <- lm(data = anthBinDataHowlsMin, formula = avg_howl_per_min ~ avg_anth_dist, weights = n_obs)
...
# null
null_howl_prob <- lm(data = anth_bin_data_howl_prob, formula = avg_roar_prob ~ 1, weights = n_obs)
...
# linear
linear_howl_prob <- lm(data = anth_bin_data_howl_prob, formula = avg_roar_prob ~ avg_anth_dist, weights = n_obs)
