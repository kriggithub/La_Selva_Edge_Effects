...
# null
nullBoutLength <- lm(data = rivBinDataBoutLength, formula = avg_bout_length_s ~ 1, weights = 1/(se_bout_length_s)^2)
...
# linear
linearBoutLength <- lm(data = rivBinDataBoutLength, formula = avg_bout_length_s ~ avg_riv_dist, weights = 1/(se_bout_length_s)^2)
...
logisticBoutLength <- nlsLM(avg_bout_length_s ~ a/(1+(b * exp(-c*(avg_riv_dist-0)/100))) + d, data = rivBinDataBoutLength, 
                            start = list(a = 0, b = 20, c = 2.5, d = 40), weights = 1/(se_bout_length_s)^2, control = nls.lm.control(maxiter = 1000))
...
# null
nullNbouts <- lm(data = rivBinDataNbouts, formula = avg_n_howls_in_bout ~ 1, weights = 1/(se_n_howls_in_bout)^2)
...
# linear
linearNbouts <- lm(data = rivBinDataNbouts, formula = avg_n_howls_in_bout ~ avg_riv_dist, weights = 1/(se_n_howls_in_bout)^2)
...
powerabcNbouts <- nlsLM(avg_n_howls_in_bout ~ a * ((avg_riv_dist)^b) + c, data = rivBinDataNbouts, 
                        start = list(a = 1, b = 1, c = 80), weights = 1/(se_n_howls_in_bout)^2, control = nls.lm.control(maxiter = 1000))
...
logisticNbouts <- nlsLM(avg_n_howls_in_bout ~ a/(1+(b * exp(-c*(avg_riv_dist-0)/100))) + d, data = rivBinDataNbouts, 
                        start = list(a = 90, b = 20, c = 2.5, d = 40), weights = 1/(se_n_howls_in_bout)^2, control = nls.lm.control(maxiter = 1000))
...
# null
nullHowlMin <- lm(data = rivBinDataHowlMin, formula = avg_howl_per_min ~ 1, weights = 1/(se_howl_per_min)^2)
...
# linear
linearHowlMin <- lm(data = rivBinDataHowlMin, formula = avg_howl_per_min ~ avg_riv_dist, weights = 1/(se_howl_per_min)^2)
...
riv_bin_data_n_bouts <- riv_bin_data_n_bouts %>% 
  filter(!is.na(avg_roar_bout_per_h), se_roar_bout_per_h > 0)
########################################################################################

# null
null_n_bouts <- lm(data = riv_bin_data_n_bouts, formula = avg_roar_bout_per_h ~ 1, weights = 1/(se_roar_bout_per_h)^2)
...
# linear
linear_n_bouts <- lm(data = riv_bin_data_n_bouts, formula = avg_roar_bout_per_h ~ avg_riv_dist, weights = 1/(se_roar_bout_per_h)^2)
...
# null
null_howl_prob <- lm(data = riv_bin_data_howl_prob, formula = avg_roar_prob ~ 1, weights = 1/(se_roar_prob)^2)
...
# linear
linear_howl_prob <- lm(data = riv_bin_data_howl_prob, formula = avg_roar_prob ~ avg_riv_dist, weights = 1/(se_roar_prob)^2)
